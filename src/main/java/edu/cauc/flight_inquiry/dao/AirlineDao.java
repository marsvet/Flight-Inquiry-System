...
public interface AirlineDao extends JpaRepository<Airline, String>, JpaSpecificationExecutor<AirlineDao> {
  ...
  public List<Airline> getAirlines(String zhSimpleName, String enSimpleName, String zhFullName, String enFullName, String twoCode, String threeCode, String airlineType, int offset, int limit);
