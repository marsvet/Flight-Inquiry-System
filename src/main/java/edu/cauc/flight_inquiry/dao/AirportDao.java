...
public interface AirportDao extends JpaRepository<Airport, String>, JpaSpecificationExecutor<Airport> {
  ...
  public List<Airport> getAirports(String zhSimpleName, String enSimpleName, String zhFullName, String enFullName, String threeCode, String fourCode, String airportType, int offset, int limit);
